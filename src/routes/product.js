...
router.get('/admin/product/:id', verifyToken, product.getOneProductBySlug);
router.put('/admin/product/:id', verifyToken, product.updateProductBySlug);

router.delete('/admin/product/:id', verifyToken, product.deletedProductBySlug);
